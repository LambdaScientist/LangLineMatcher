...
data OS = Windows | Linux deriving (Show,Eq)
os = Linux

fileName = if os == Linux then fileNameL else fileNameW
fileNameW = "\\dsc_fpga\\src\\dsc_fpga.vhd"
fileNameL = "/dsc_fpga/src/dsc_fpga.vhd"
...
testPath = "/home/swatLnxShare/Code/SprintFW61" -- "Z:\\protected\\src\\SprintFW61\\"
...
edgeList = cleanMatch "/home/swatLnxShare/Code/SprintFW61" vhdl <$> lineMatch
